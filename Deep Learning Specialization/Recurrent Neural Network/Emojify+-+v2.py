...
X_my_sentences = np.array(["i adore you", "i love you", " lets eat", "lets play with a ball", "food is ready", "not feeling happy"])
...
def sentences_to_indices(X, word_to_index, max_len):
    ...
    X_indices = np.zeros((m, max_len))   # numpy.zeros((m,max_len))
...
x_test = np.array(['not feeling not good to see you '])
X_test_indices = sentences_to_indices(x_test, word_to_index, maxLen)
